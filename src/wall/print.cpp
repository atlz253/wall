...
void printWarning(const std::string message) { std::cout << YELLOW << message << WHITE << std::endl; }
...
void printTrace(const std::string message) { std::cout << GREY << message << WHITE << std::endl; }
...
void printError(const std::string message) { std::cout << RED << message << WHITE << std::endl; }
...
void printDebug(const std::string message) { std::cout << message << std::endl; }
